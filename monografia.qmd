...
E também serão utilizadas variáveis de interação, que estimam o efeito em pares de estados possíveis para as variáveis de escolaridade, sexo e raça/cor (e.g., o efeito de ser do sexo masculino e da cor branca é representado pela interação $X_7 \times X_9$).
...
Formalmente, a heteroscedasticidade é testada com o teste de White, que é um teste de hipótese que compara o ajuste de um modelo de regressão linear com e sem termos quadráticos e de interação. O teste é realizado a seguir. Com p-valor quase nulo, rejeitamos a hipótese nula de homoscedasticidade, como esperado.
...
Para corrigir a heteroscedasticidade e obter testes de hipóteses válidos, utilizo correção de White para erros padrões robustos. Os resultados da estimação na @tbl-modelos já incluem os erros padrões robustos.
...
Os resultados da estimação dos modelos de regressão linear múltipla para os anos de 2022 e 2006 são apresentados na @tbl-modelos a seguir.
