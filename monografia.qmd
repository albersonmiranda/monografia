...
Neste trabalho, mostro que

Ao longo das décadas, o incremento nos ganhos médios do trabalhador a cada ciclo completo de escolaridade vem diminuindo consistentemente. 
...
m2020 = lm(
    ...
    grau_instrucao + sexo + raca_cor + idade + idade^2 +
    # interação
    sexo * raca_cor,
    # dataset
    data = rais
...
# parâmetros
parameters::model_parameters(m2020, exponentiate = TRUE)
```
