...
\usepackage{config/tema/ifestex}	% customização para PPGEco/UFES
% ---
...
\setmonofont[Scale=0.9, Scale=MatchLowercase]{Ubuntu Mono}
...
% bibliografia
\addbibresource{config/elementos/monografia.bib}
